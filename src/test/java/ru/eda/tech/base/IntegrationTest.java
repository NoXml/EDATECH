...
import ru.eda.tech.repo.entity.EntityRepoImpl;
...
@WebMvcTest({EntityController.class, InfoController.class, EntityServiceImpl.class, EntityRepoImpl.class, ControllerExceptionHandler.class})
